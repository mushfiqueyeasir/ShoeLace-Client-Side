...
const InventoryBody = ({ inventories, navigation }) => {
          ...
          {navigation === "inventory" ? (
            ...
            <>
              ...
              <div className="d-flex justify-content-end">
                <Link to="/inventory" className="seeMore p-3">
                  See All <i className="fa-solid fa-circle-chevron-down"></i>
                </Link>
              </div>
            </>
          )}
