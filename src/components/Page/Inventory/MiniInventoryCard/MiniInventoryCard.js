      ...
      <div className="card flex-row ">
        ...
        <div className="card-body d-flex flex-column justify-content-between">
          ...
          <div className="d-flex justify-content-between">
            ...
            {quantity !== "0" ? (
              <h2 className="price fs-5">
                <i className="fas fa-sort-amount-up text-dark "></i>
                {quantity}
              </h2>
            ) : (
              <h2 className="price fs-6 text-danger">
                <i className="fas fa-sort-amount-up text-danger"></i>Sold Out
              </h2>
            )}
          </div>
        </div>
        <div className="d-flex align-items-center justify-content-center">
          <button id={_id} onClick={handleDelete} className="bttn fs-2">
            {" "}
